(function() {
  ...
  var config = {
      clientId: 'hoHoaHf7oQfVabWSuktnrXfAIIGXXVA74dmIGpgw',
  ...
  $(document).ready(function() {
      ...
      $("#getdatabutton").click(function() {
          ...
          var jsonUrl = config.authUrl + "api/v1/data/" + formid +".json?sort={\"_id\":1}"
  ...
  function doAuthRedirect() {
      ...
      var url = config.authUrl + 'o/authorize?response_type=code&client_id=' + appId +
              ...
              if (table_meta.headers) {
                  ...
                  for (var fieldName in headers) {
                    if (headers.hasOwnProperty(fieldName)) {
                      cols.push({ id: fieldName, dataType: headers[fieldName]});
                    }
                  }
